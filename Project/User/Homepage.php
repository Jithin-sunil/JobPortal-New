                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="menu-has-children" ><a href="">My Account</a>
                            <ul>
                                ...
                                <li><a href="Userlanguage.php">My Languages</a></li>
                                <li><a href="Usertechnicalskill.php">My Skills</a></li>
                                <li><a href="Userqualification.php">My Qualification</a></li>
            ...
            <div class="row align-items-center">
                <div class="active-popular-post-carusel">
                    <div class="single-popular-post d-flex flex-row">
                        <div class="thumb">
                            <img class="img-fluid" src="../Assets/Templates/Main/img/p1.png" alt="">
                    ...
                    <div class="single-popular-post d-flex flex-row">
                        <div class="thumb">
                            <img src="../Assets/Templates/Main/img/p2.png" alt="">
                            <a class="btns text-uppercase" href="#">view job post</a>
                        </div>
                        <div class="details">
                            <a href="#">
                    ...
                    <div class="single-popular-post d-flex flex-row">
                        <div class="thumb">
                            <img src="../Assets/Templates/Main/img/p1.png" alt="">
                            <a class="btns text-uppercase" href="#">view job post</a>
                        </div>
                        <div class="details">
                            <a href="#">
            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8 post-list">
                    ...
                    <div class="single-post d-flex flex-row">
                        <div class="thumb">
                            <img src="../Assets/Templates/Main/img/post.png" alt="">
                            <ul class="tags">
                                <li>
                                    <a href="#">Art</a>
                                </li>
                ...
                <div class="col-lg-4 sidebar">
                    ...
                    <div class="single-slidebar">
                        ...
                        <div class="active-relatedjob-carusel">
                            <div class="single-rated">
                                <img class="img-fluid" src="../Assets/Templates/Main/img/r1.jpg" alt="">
                                <a href="single.html">
                                    <h4>Creative Art Designer</h4>
                                </a>
                                <h6>Premium Labels Limited</h6>
                    ...
                    <div class="single-slidebar">
                        ...
                        <div class="blog-list">
                            <div class="single-blog " style="background:#000 url(../Assets/Templates/Main/img/blog1.jpg);">
                                <a href="single.html">
                            ...
                            <div class="single-blog " style="background:#000 url(../Assets/Templates/Main/img/blog2.jpg);">
                                <a href="single.html">
                                    <h4>Home Audio Recording <br>
                                        For Everyone</h4>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 download-left">
                    <img class="img-fluid" src="../Assets/Templates/Main/img/d1.png" alt="">
                </div>
                ...
                <div class="col-lg-3  col-md-12">
                    <div class="single-footer-widget mail-chimp">
                        ...
                        <ul class="instafeed d-flex flex-wrap">
                            <li><img src="../Assets/Templates/Main/img/i1.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i2.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i3.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i4.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i5.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i6.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i7.jpg" alt=""></li>
                            <li><img src="../Assets/Templates/Main/img/i8.jpg" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
