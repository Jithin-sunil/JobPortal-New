...
if (isset($_GET['del_id'])) {
    ...
    $delQry = "DELETE FROM tbl_complaint WHERE complaint_id = '" . $complaintId . "' AND company_id = '" . $_SESSION['cid'] . "'";
    if ($Con->query($delQry)) {
       ?>
       <script>
...
if (isset($_POST['btn_submit'])) {
    ...
    $insQry = "INSERT INTO tbl_complaint(complaint_title, complaint_content, company_id, complaint_date) 
            ...
            <div class="complaint-table">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $i = 0;
                        $selQry = "SELECT * FROM tbl_complaint WHERE company_id = '" . $_SESSION['cid'] . "' ORDER BY complaint_date DESC";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($data['complaint_status'] == 0) {
                                    echo '<span class="status-pending">Not Replied Yet</span>';
                                } else {
                            ...
                            <td>
                                <a href="Complaint.php?del_id=<?php echo $data['complaint_id']; ?>" class="action-link" onclick="return confirm('Are you sure you want to delete this complaint?');">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
